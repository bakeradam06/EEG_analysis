...
```
```{r - "How does CMC of PML-APB associate with baseline WMFT score during prep phase before grip?"}
# needs: 
  # baseline WMFT, CMC scores of prep phase, no execution phase here
  # keep beta, gamma, novib. Don't include Vib in this. 

# exclude data i want now (see above)
