...
tempPMLM1Ldata.df <- filtDataGamExe.df %>%
  filter(connection %in% c("PML-APB","PML-FDI","M1L-APB","M1-FDI","PML-FDS","PML-EDC","M1L-FDS","M1L-EDC"))
# model
modGamExeNHPT <-  lm(meanCoh ~ 
                      NHPTafffected +
                      connection +
                      session,
...
filtData3.df <- right_join(filtData3.df, NHPTdistinct, by=c("Subject","session"))
