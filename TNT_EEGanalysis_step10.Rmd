...
model_parameters(modGamExeNHPTa)
# model - BBT
...
model_parameters(modGamExeBBTa)
...
temp_filtData3.df <- filtData3.df %>%
  ...
  filter(connection %in% c("PML-EDC"),
         session %in% c("Baseline"))
# model - NHPT
modGamExeNHPTb <-  glm(NHPTafffected ~ 
                       meanCoh,
...
# model - BBT
modGamExeBBTb <-  glm(BBTaffected ~ 
                       meanCoh,
                       data = temp_filtData3.df
                       )
Anova(modGamExeBBTb, type = 'III')
model_parameters(modGamExeBBTa)
cor(temp_filtData3.df$meanCoh,temp_filtData2.df$NHPTafffected)
cor(temp_filtData3.df$meanCoh,temp_filtData2.df$BBTaffected)
