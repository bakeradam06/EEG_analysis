...
%%
% reformat the subj naming convention in wolfData
...
%% get rid of phone call rows. don't want them.
...
groupAllocation = readtable('TNT_allData_2025-10-31.xlsx',Sheet = "GroupAllocation"); % ctrl=0 trt=1
...
clinicalData = innerjoin(clinicalData, groupAllocation, 'Keys', 'subject');
