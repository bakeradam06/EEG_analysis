...
%% average the NoVib data for Pre Post and FU
    ...
    for iTable=1:length(tableDir)
        ...
        if iTable == 1
            ...
            for rowPre = 1:preTrialsAvailableNV % Uses dynamically detected trials
...
clear betaPrepAllNVExc alphaExeAllNV  ...
    betaExeAllNV betaPrepAllNV
