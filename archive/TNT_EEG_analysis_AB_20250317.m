...
preRows = outputCohAll.timePoint == "Pre";
postRows = outputCohAll.timePoint == "Post";

% Ensure region pairs match 
assert(isequal(outputCohAll.regionPair(preRows), outputCohAll.regionPair(postRows)), "Region Pairs must match!");
