...
%% coming back to the master tables for subjects

% sort rows by subject and region pair
masterAlphaPrep = sortrows(masterAlphaPrep, {'subjectID', 'regionPair'});
masterAlphaExe = sortrows(masterAlphaExe, {'subjectID', 'regionPair'});
masterBetaPrep = sortrows(masterBetaPrep, {'subjectID', 'regionPair'});
masterBetaExe = sortrows(masterBetaExe, {'subjectID', 'regionPair'});
